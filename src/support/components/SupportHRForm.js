  ...
  return (
    <>
      ...
      <form className="supportForm" onSubmit={saveToDatabase}>
        ...
        {/*<div className="form-outline mb-4">*/}
        {/*  <label className="form-label" for="Attachment">Attach File If Needed</label>*/}
        {/*  <input className="form-control" type="file" id="Attachment"></input>*/}
        {/*</div>*/}
